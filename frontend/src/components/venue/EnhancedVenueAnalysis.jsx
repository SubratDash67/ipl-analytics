...
import { MapPin, BarChart3, TrendingUp, Target, Globe } from 'lucide-react'
import OfficialIndiaMap from '../map/OfficialIndiaMap'
import LoadingSpinner from '../common/LoadingSpinner'
import PerformanceChart from '../stats/PerformanceChart'

const EnhancedVenueAnalysis = ({ batter, bowler }) => {
  ...
  // Get comprehensive venue statistics for map visualization [11]
  ...
  // Calculate venue performance metrics for analysis [10]
    ...
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2 flex items-center justify-center">
          ...
          Official IPL Venue Performance Analysis
        </h2>
        <p className="text-gray-600">
          {batter} vs {bowler} • Interactive map based on Government of India boundaries
        </p>
      </div>

      {/* Performance overview cards [12] */}
      {insights && (
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold text-gray-900 flex items-center">
              ...
              {selectedVenue} Performance Analysis
            </h3>
            <button
          ...
          {venueLoading ? (
            ...
            <div className="card text-center py-8">
              <p className="text-gray-500">
                No performance data available for this venue in the selected matchup
              </p>
            </div>
          )}
        </div>
      ...
      {/* Comprehensive venue comparison table [13] */}
      {allVenueStats && Object.keys(allVenueStats).length > 0 && (
        <div className="card">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">
            Complete Venue Performance Summary
          </h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-right py-3 px-2 font-medium text-gray-900">Strike Rate</th>
                  <th className="text-right py-3 px-2 font-medium text-gray-900">Economy</th>
                  <th className="text-right py-3 px-2 font-medium text-gray-900">Boundaries</th>
...
export default EnhancedVenueAnalysis
